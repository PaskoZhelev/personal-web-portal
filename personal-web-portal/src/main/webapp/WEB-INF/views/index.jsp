...
<meta name="description" content="personal professional description">
<meta name="keywords" content="portfolio keywords, portal keywords">
<meta http-equiv="content-type" content="text/html; charset=windows-1252">
<link rel="stylesheet" type="text/css" href="../style/style.css" title="style"></head><body>
  <div id="main">
    <div id="header">
      <div id="logo">
        <div id="logo_text">
          <!-- class="logo_colour", allows you to change the colour of the text -->
          <c:url var="redirectIndex" value="/index"/>
    ...
    <div id="site_content">
      <div class="sidebar">
        ...
        <form:form action="/personal-web-portal/index" method="get" modelAttribute="postForm">
         <table>
           <tr>
              <td>Subject:</td>
           </tr>
      ...
      <div id="content">
             ...
             <c:url var="redirectIndexUpdate" value="/index_redirect"/>
